						...
						<div class="box well grad_colour_dark_blue">
                            ...
                            <ul class="nav nav-tabs" style="margin-bottom: 10px;">
								...
								<div class="row-fluid">
									...
									<p>Zerotier是一个开源，跨平台，而且适合内网穿透互联的傻瓜配置虚拟VPN组网<br>
									</p>
									</div>
...
<tr><th>ZeroTier Network ID</th>
			...
			<tr>
										...
										<tr>
											<th>zerotier官网</th>
											<td>
				<input type="button" class="btn btn-success" value="zerotier远程管理界面" onclick="window.open('https://my.zerotier.com/network')" size="0">
